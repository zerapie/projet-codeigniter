                ...
                <div class="container">
                    ...
                    <section class="invoice-list-wrapper section">
                        ...
                        <div class="invoice-create-btn">
                            <a href="<?php echo base_url('Admin/Code/edit');?>" class="btn waves-effect waves-light invoice-create border-round z-depth-4">
                                <i class="material-icons">add</i>
                                <span class="hide-on-small-only">Create Code</span>
                            </a>
                        </div>
